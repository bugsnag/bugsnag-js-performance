import { type Persistence, ResourceAttributes, type InternalConfiguration } from '@bugsnag/core-performance'
import cuid from '@bugsnag/cuid'
import { Platform } from 'react-native'
import { type ReactNativeConfiguration } from './config'

export function createResourceAttributesSource (persistence: Persistence) {
  return function resourceAttributesSource (config: InternalConfiguration<ReactNativeConfiguration>) {
