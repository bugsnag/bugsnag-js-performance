Feature: Network spans
    ...
    Scenario: Network spans are not instrumented for failed XHR requests
        Given I navigate to the test URL "/network-spans"
        When I click the element "xhr-failure"
        Then I should have received no spans

    Scenario: Network spans are not instrumented for failed fetch requests
        Given I navigate to the test URL "/network-spans"
        When I click the element "fetch-failure"
        Then I should have received no spans